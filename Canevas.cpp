...
//codigo para llenar una superficie por parte de la pintura
...
//funciones de las ranuras
void Canevas::sauvegarderCanevas()
{
    QString fichier = QFileDialog::getSaveFileName(0, "Guaardar imagen", QString(), "Imagen (*.png *.gif *.jpg *.jpeg)");
...
{
    QString fichier = QFileDialog::getOpenFileName(0,"Abrir imagen",QString(),"Imagen (*.png *.gif *.jpg *.jpeg)");
    painter->end();
    delete painter;
    pixmapListe.remove(pixActuel);
